...
## 34. Step 20 — API completeness (CSV contract)

Цель:
- зафиксировать контракт CSV endpoint
- довести Swagger до полного описания API

Подход:
- описать структуру CSV в документации endpoint
- добавить response_class и media_type

Результат:
- все endpoints имеют явный контракт
